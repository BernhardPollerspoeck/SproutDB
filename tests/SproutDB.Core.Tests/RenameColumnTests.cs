...
public class RenameColumnTests : IDisposable
{
    ...
    {
        var r = _engine.ExecuteOne("rename column users.name to username", "testdb");
    ...
    {
        _engine.ExecuteOne("rename column users.name to username", "testdb");
        var r = _engine.ExecuteOne("upsert users {username: 'Jane', age: 30}", "testdb");
    ...
    {
        var r = _engine.ExecuteOne("rename column users.name to name", "testdb");
    ...
    {
        var r = _engine.ExecuteOne("rename column users.missing to newname", "testdb");
    ...
    {
        var r = _engine.ExecuteOne("rename column users.name to age", "testdb");
    ...
    {
        var r = _engine.ExecuteOne("rename column missing.col to newcol", "testdb");
    ...
    {
        var r = _engine.ExecuteOne("rename column users.name to username", "nope");
