...
public class DeleteTests : IDisposable
{
    ...
    public DeleteTests()
    {
        ...
        _engine.Execute("upsert users {name: 'Alice', age: 28}", "testdb");
        _engine.Execute("upsert users {name: 'Bob', age: 35}", "testdb");
        _engine.Execute("upsert users {name: 'Charlie', age: 22}", "testdb");
        _engine.Execute("upsert users {name: 'Diana', age: 28}", "testdb");
    }
    ...
    {
        var r = _engine.Execute("delete users where age < 25", "testdb");
    ...
    {
        var r = _engine.Execute("delete users where age = 28", "testdb");
    ...
    {
        var r = _engine.Execute("delete users where age > 100", "testdb");
    ...
    {
        var r = _engine.Execute("delete users", "testdb");
    ...
    {
        var r = _engine.Execute("delete users where xyz = 1", "testdb");
    ...
    {
        _engine.Execute("delete users where age < 25", "testdb");
    ...
    public void Delete_AllRows()
    {
        ...
        var get = _engine.Execute("get users", "testdb");
    ...
    {
        var r1 = _engine.Execute("delete users where age < 25", "testdb");
        Assert.Equal(1, r1.Affected);

        var r2 = _engine.Execute("delete users where age < 25", "testdb");
    ...
    public void Delete_ComplexWhere()
    {
        ...
        var r = _engine.Execute("delete users where age = 28 and name = 'Alice'", "testdb");
