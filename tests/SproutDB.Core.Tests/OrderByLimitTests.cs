...
public class OrderByLimitTests : IDisposable
{
    ...
    {
        var r = _engine.ExecuteOne("get users order by name", "testdb");
    ...
    {
        var r = _engine.ExecuteOne("get users order by age desc", "testdb");
    ...
    public void OrderBy_Multiple()
    {
        ...
        var r = _engine.ExecuteOne("get users order by age desc, name", "testdb");
    ...
    {
        var r = _engine.ExecuteOne("get users where age > 25 order by name", "testdb");
    ...
    {
        var r = _engine.ExecuteOne("get users order by _id desc", "testdb");
    ...
    {
        var r = _engine.ExecuteOne("get users order by missing", "testdb");
    ...
    {
        var r = _engine.ExecuteOne("get users limit 2", "testdb");
    ...
    {
        var r = _engine.ExecuteOne("get users order by age desc limit 2", "testdb");
    ...
    {
        var r = _engine.ExecuteOne("get users limit 100", "testdb");
    ...
    {
        var r = _engine.ExecuteOne("get users limit 0", "testdb");
    ...
    {
        var r = _engine.ExecuteOne("get users where age > 25 limit 1", "testdb");
    ...
    {
        var r = _engine.ExecuteOne("get users where age > 25 count", "testdb");
    ...
    {
        var r = _engine.ExecuteOne("get users where age > 100 count", "testdb");
    ...
    {
        var r = _engine.ExecuteOne("get users select age distinct", "testdb");
    ...
    {
        var r = _engine.ExecuteOne("get users select age distinct where age > 25", "testdb");
    ...
    {
        var r = _engine.ExecuteOne("get users select name distinct", "testdb");
    ...
    {
        var r = _engine.ExecuteOne("get users select age distinct count", "testdb");
