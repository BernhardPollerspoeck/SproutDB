...
public class AlterColumnTests : IDisposable
{
    ...
    {
        var r = _engine.Execute("alter column users.name string 500", "testdb");
    ...
    {
        _engine.Execute("upsert users {name: 'Alice', age: 25}", "testdb");
        _engine.Execute("upsert users {name: 'Bob', age: 30}", "testdb");
    ...
    public void AlterColumn_ExpandSize_CanWriteLongerStrings()
    {
        ...
        var r = _engine.Execute($"upsert users {{name: '{longName}'}}", "testdb");
    ...
    {
        var r = _engine.Execute("alter column users.name string 50", "testdb");
    ...
    public void AlterColumn_ShrinkSize_DataTruncated()
    {
        ...
        _engine.Execute("upsert users {name: 'Alexander Hamilton'}", "testdb");

        _engine.Execute("alter column users.name string 5", "testdb");
    ...
    {
        _engine.Execute("upsert users {name: 'Bob'}", "testdb");

        _engine.Execute("alter column users.name string 50", "testdb");
    ...
    {
        var r = _engine.Execute("alter column users.name string 100", "testdb");
    ...
    {
        var r = _engine.Execute("alter column users.missing string 100", "testdb");
    ...
    {
        var r = _engine.Execute("alter column users.age string 100", "testdb");
    ...
    {
        var r = _engine.Execute("alter column missing.name string 100", "testdb");
    ...
    {
        var r = _engine.Execute("alter column users.name string 100", "nope");
    ...
    {
        _engine.Execute("upsert users {age: 25}", "testdb"); // name is null
